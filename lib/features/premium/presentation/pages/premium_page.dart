      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 32.h),
            _buildFeatureItem(Icons.volume_up, 'High Quality Audio', 'Listen in crystal clear audio'),
            _buildFeatureItem(Icons.skip_next, 'Unlimited Skips', 'Skip as many songs as you want'),
            _buildFeatureItem(Icons.download, 'Offline Downloads', 'Download songs and listen offline'),
            _buildFeatureItem(Icons.block, 'Ad-Free', 'No ads, no interruptions'),
            SizedBox(height: 40.h),
            Container(
              width: double.infinity,
