...
class _RecentlyPlayedPageState extends ConsumerState<RecentlyPlayedPage> {
  ...
  Future<void> _loadMore() async {
    ...
    final result = await backend.getPlayHistory(
      offset: _offset,
      limit: _pageSize,
      returnTotal: false,
    );
    final batch = result as List<Map<String, dynamic>>;
  ...
  Future<void> _deleteEntry(String songId) async {
    ...
    if (ok && mounted) {
      setState(
        () => _entries.removeWhere((e) => (e['song'] as Map?)?['id'] == songId),
      );
              ...
              : Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        '${_entries.length}${_hasMore ? '+' : ''} entries',
                        style: TextStyle(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Dismissible(
                              ...
                              child: ListTile(
                                ...
                                subtitle: Text(
                                  '${song['subtitle'] ?? ''}  •  ${item['count'] ?? 0} plays',
                                  style: TextStyle(
