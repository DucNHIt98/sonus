          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                ...
                title: Text(song['title'] ?? '', style: TextStyle(color: Colors.white, fontSize: 15.sp, fontWeight: FontWeight.w500), maxLines: 1, overflow: TextOverflow.ellipsis),
                subtitle: Text('${song['subtitle'] ?? ''}  •  ${item['count'] ?? 0} plays', style: TextStyle(color: Colors.grey[400], fontSize: 13.sp), maxLines: 1, overflow: TextOverflow.ellipsis),
              );
            },
          );
        },
