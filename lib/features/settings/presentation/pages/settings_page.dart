  ...
  Widget _buildSettingTile(BuildContext context, IconData icon, String title, {String? subtitle, bool enabled = true, VoidCallback? onTap}) {
    return ListTile(
      ...
      leading: Container(
        ...
        decoration: BoxDecoration(color: Colors.white.withOpacity(0.08), borderRadius: BorderRadius.circular(8.r)),
        child: Icon(icon, color: Colors.white, size: 20.r),
      ),
      title: Text(title, style: TextStyle(color: enabled ? Colors.white : Colors.white38, fontSize: 15.sp, fontWeight: FontWeight.w500)),
      subtitle: subtitle != null ? Text(subtitle, style: TextStyle(color: Colors.grey[500], fontSize: 12.sp)) : null,
      trailing: enabled ? Icon(Icons.chevron_right, color: Colors.white24, size: 20.r) : null,
